...
##                self.bitsRBW # JGH line changed for next one
    ...
    def InitializeHardware(self):
        ...
        if not hardwarePresent:
            print ("\n>>>2395<<<\n" \
                   "**** NO HARDWARE PRESENT, USING SYNTHETIC DATA ****\n")
        ...
        if p.cftest == 0: # JGH starts 2/3/14
            ...
            LO2.CreateIntegerNcounter(self.appxLO2, msa.masterclock)
            ...
            LO2=((Bcounter*preselector)+Acounter+(fcounter/16))*pdf2 #actual LO2 frequency   ????? pdf2 = LO2.pdf
            #CommandPLL2N
            Jcontrol = SELT
            LEPLL = 8
            datavalue = 16
